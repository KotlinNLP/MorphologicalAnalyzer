...
offset
    : offset_unit_prefix SPACE_SEP (date | date_unit_literal | time_unit_literal)
    | (offset_pos_prefix | offset_neg_prefix) SPACE_SEP offset_units SPACE_SEP date_unit_literal
    | offset_units SPACE_SEP date_unit_literal
    ;
